...
构建模式会显著影响性能表现（各模式的区别见[构建系统章节](../part1-basics/chapter-build-system.md)）。性能比较前先确认你用的是哪种模式。
...
调试时可以用 `std.debug.assert`（见[控制流章节](../part1-basics/chapter-control-flow.md)）在关键位置验证假设。
